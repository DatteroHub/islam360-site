    ...
    <Layout>
      <BgDiv className="py-24 mt-12">
        <ContentDiv className="flex justify-center items-center gap-40">
          <div>
            <h1 className="font-semibold text-center text-8xl md:text-9xl text-gray-700">404</h1>
            <div className="font-medium text-center text-2xl text-gray-500 mt-6">Pagina non trovata</div>
          </div>
