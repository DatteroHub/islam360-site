      ...
      <ContentDiv className="pb-8">
        <footer className="flex flex-col md:flex-row gap-6 md:gap-4">
          ...
          <div className='flex-1'>
            ...
            <LinkBox href="https://t.me/islam360ita/" src={'/telegram.svg'} alt="Telegram Logo" iconSize="h-8" className="text-medium text-sky-50 hover:bg-white/10">Scrivici su Telegram</LinkBox>
